        ...
        <div class="scroll2">
            <table class="table">
                ...
                <tr :key="index" v-for="(item,index) in medols">
                    <td><input type="checkbox" v-model="delData" :value="index"></td>
                    <td>{{index-(-1)}}</td>
            ...
            <div style="padding:20px 10px;">
                ...
                <div>
                    <p style="line-height:50px;text-align:center;">
                        ...
                        <input v-model="sName" type="text" class="txt"/>
                    </p>
                    <p style="line-height:50px;text-align:center;">
...
export default {
  ...
  mounted() {
    this.$nextTick(() => {
      this.scroll = new BScroll(".scroll2", {
  ...
  methods:{
      ...
      save(){
          ...
          this.isLoading=true;
          this.$http.post("/maintenanceService/maintenance/updateTransformerWinding?sign="+this.token,
              arr)
              .then(res=>{
                  if(res.data.code==1){
                      this.close=false;
