<template lang="html">
  <div class="main">
    ...
    <span class="bread_nav">换表事件</span>
    <div class="mxian_succ">
      <div class="tool_bar event_tool_bar">
        ...
        <button class=" primary status_btn right" @click="getData()">查询</button>
      ...
      <div class="events_wrap">
        ...
        <div class="event_table_main">
          <div class="table_tool">
            <router-link class="right btn" :to="{ path: paths+'/addmeters', query: {sysId:$route.query.sysId,sonid:$route.query.sonid} }">新增</router-link>
            <router-link  class="right btn" :to="{ path: paths+'/status', query: {sysId:$route.query.sysId,sonid:$route.query.sonid,type:2,}}">查看重计算任务状态</router-link>
            ...
            <thead>
              <tr>
                ...
                <td style="position: relative;">
                  开始时间
                  <div class="common_sort">
                    <span class="positive_sequence" @click="orderColumn='changeStartTime';direction=1;getData()"></span>
                    <span class="reverse_order" @click="orderColumn='changeStartTime';direction=0;getData()"></span>
                  </div>
                </td>
                <td style="position: relative;">
                  结束时间
                  <div class="common_sort">
                    <span class="positive_sequence" @click="orderColumn='changeEndTime';direction=1;getData()"></span>
                    <span class="reverse_order" @click="orderColumn='changeEndTime';direction=0;getData()"></span>
                  </div>
                </td>
                <!-- <td>处理状态</td> -->
              </tr>
            ...
            <table class="table">
              <tbody>
                <tr v-for="(item,index) in dataList">
                  ...
                  <td>{{item.changeStartTime}}</td>
                  <td>{{item.changeEndTime}}</td>
...
import float from "../common/float1";
...
export default {
  ...
  data() {
    return {
      ...
      hasCheckAll: false,
      loading: true,
      centerDialogVisible: false.status,
      con: false,
      orderColumn:'',
      direction:1
    };
