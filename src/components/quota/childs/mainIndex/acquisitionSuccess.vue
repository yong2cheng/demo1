<template lang="html">
    <div class="cjcgl_count count_common">
                ...
                <div class="count_top_tc">
                    <div>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table">
                            <thead>
                                <tr>
                                    <td colspan="7" class="count_bottom_title clearfix">地区采集成功率
                                        <button class="btness" @click="getDownload()">下载</button>
                                    </td>
                                </tr>
                                <tr>
                                    <th>序号</th>
                    ...
                    <div class="scroll2" style="position:relative;height:360px;overflow:hidden;">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table">
                            <tbody>
